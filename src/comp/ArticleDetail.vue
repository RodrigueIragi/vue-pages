            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="image-container-large">
                        <img class="img-fluid" src="../assets/images/article-details-large.jpg" alt="alternative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled li-space-lg indent">
                                    ...
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">User generated content (such as messages, posts, comments, pages, profiles, ../assets/images, feeds or communications exchanged on the Supported Platforms that can be used)</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">../assets/Images or other files that you may publish via our Services</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Information (such as messages, posts, comments, pages, profiles, ../assets/images) we may receive relating to communications you send us, such as queries or comments concerning</div>
                                    </li>
                                </ul>
                            </div> <!-- end of col -->
                        </div> <!-- end of row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="image-container-small">
                                    <img class="img-fluid" src="../assets/images/article-details-small.jpg" alt="alternative">
